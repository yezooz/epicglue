...
-(void)repositionProgressView
{
    self.xl_progressIndicatorView.frame = CGRectMake(0, 0, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds));
}
...
{
    [self setImageWithProgressIndicatorAndURL:url placeholderImage:nil imageDidAppearBlock:nil success:success failure:failure progressIndicatorCenterPoint:self.center];
}
...
{
    [self setImageWithProgressIndicatorAndURL:url placeholderImage:placeholderImage imageDidAppearBlock:imageDidAppearBlock success:NULL failure:NULL progressIndicatorCenterPoint:indicatorCenter];
}
              ...
              progressIndicatorCenterPoint:(CGPoint)indicatorCenter
{
    ...
    [self.xl_progressIndicatorView setStrokeRemainingColor:kXLCircleProgressIndicatorDefaultStrokeRemainingColor];
    if (![self.xl_progressIndicatorView superview]){
        [self addSubview:self.xl_progressIndicatorView];
    }

    [self repositionProgressView];
    ...
    [self setImageWithURLRequest:request
                placeholderImage:placeholderImage
                         ...
                         failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error) {
                             ...
                             [weakSelf.xl_progressIndicatorView setStrokeRemainingColor:[UIColor clearColor]];
                             [weakSelf repositionProgressView];
