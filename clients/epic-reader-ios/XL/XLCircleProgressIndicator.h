...
#define kXLCircleProgressIndicatorDefaultStrokeRemainingColor     [[UIColor darkGrayColor] colorWithAlphaComponent:0.1f]
#define kXLCircleProgressIndicatorDefaultStrokeWidthRatio         0.1
#define kXLCircleProgressIndicatorDefaultSize                     50.f
#define kXLCircleProgressIndicatorDefaultStrokeWidth              6.0
