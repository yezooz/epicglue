...
- (void)incrementProgress
{
    ...
    progress += increment;
    progress = (float) fmin(progress, maxProgress);
...
- (void)webViewDidStartLoad:(UIWebView *)webView
{
    ...
    _loadingCount++;
    _maxLoadCount = (NSUInteger) fmax(_maxLoadCount, _loadingCount);
...
- (BOOL)respondsToSelector:(SEL)aSelector
{
    ...
    return [self.webViewProxyDelegate respondsToSelector:aSelector] ? YES : NO;
